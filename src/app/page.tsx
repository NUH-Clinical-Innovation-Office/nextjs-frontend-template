  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start max-w-2xl w-full">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row w-full">
          <Button asChild size="lg" className="w-full sm:w-auto">
            <ExternalLink href="https://vercel.com/new?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app">
              <Image
                className="dark:invert"
                src="/vercel.svg"
                alt="Vercel logomark"
          ...
          <Button asChild variant="outline" size="lg" className="w-full sm:w-auto">
            <ExternalLink href="https://nextjs.org/docs?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app">
              Read our docs
            </ExternalLink>
          </Button>
        </div>
      ...
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center">
        ...
        <Button asChild variant="link" size="sm">
          <ExternalLink href="https://nextjs.org?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app">
